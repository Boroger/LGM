...
<article class="page-container">
	<form action="<?php echo U('Admin/roleDoAdd');?>" method="post" class="form form-horizontal" id="form-admin-role-add">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>角色名称：</label>
			<div class="formControls col-xs-8 col-sm-7">
				<input type="text" class="input-text" value="" placeholder="" id="roleName" name="role" datatype="*4-16" nullmsg="用户账户不能为空">
			</div>
		</div>
		<div class="row cl">
					...
					<dd>
						<dl class="cl permission-list2">
							...
							<dd>
								...
								<label class="">
									<input type="checkbox" value="1" name="permid_1" id="">
									添加</label>
								<label class="">
									<input type="checkbox" value="2" name="permid_2" id="">
									删除</label>
								<label class="">
									<input type="checkbox" value="3" name="permid_3" id="">
									修改</label>
								<label class="">
									<input type="checkbox" value="4" name="permid_4" id="">
									查看</label>
								<!-- <label class="">
						...
						<dl class="cl permission-list2">
							...
							<dd>
								...
								<label class="">
									...
									添加</label>
								<label class="">
									<input type="checkbox" value="5" name="permid_5" id="">
									删除</label>
								<label class="">
									<input type="checkbox" value="6" name="permid_6" id="">
									修改</label>
								<label class="">
									<input type="checkbox" value="7" name="permid_7" id="">
									查看</label>
								<!-- <label class="">
									<input type="checkbox" value="" name="user-Character-0-0-0" id="user-Character-0-0-4">
									审核</label> -->
					...
					<dd>
						<dl class="cl permission-list2">
							...
							<dd>
								<!-- value对应权限节点id，name规定格式为permid_节点id -->
								<label class="">
									<input type="checkbox" value="9" name="permid_9" id="">
									查看</label>
								<label class="">
									<input type="checkbox" value="10" name="permid_10" id="">
									删除</label>
								<!-- <label class="">
									<input type="checkbox" value="" name="user-Character-0-0-0" id="user-Character-0-0-4">
									审核</label> -->
					...
					<dd>
						<dl class="cl permission-list2">
							...
							<dd>
								<!-- value对应权限节点id，name规定格式为permid_节点id -->
								<label class="">
									<input type="checkbox" value="11" name="permid_11" id="">
									查看</label>
								<label class="">
									<input type="checkbox" value="12" name="permid_12" id="">
									删除</label>
								<!-- <label class="">
									<input type="checkbox" value="" name="user-Character-0-0-0" id="user-Character-0-0-4">
									审核</label> -->
