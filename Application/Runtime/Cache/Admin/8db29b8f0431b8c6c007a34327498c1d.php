		...
		<table class="table table-border table-bordered table-bg">
			...
			<tbody>
				<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr class="text-c">
						...
						<td class="td-status">
							<?php if($v["state"] == '0'): ?><span class="label radius">已停用</span>
	                   		<?php else: ?><span class="label label-success radius">已启用</span><?php endif; ?>
						</td>
						<td class="td-manage">

							<a style="text-decoration:none" href="<?php echo U('changeState',array('id'=>$v['id'],'state'=>0));?>" title="启/停用"><i class="Hui-iconfont">&#xe61d;</i></a>

							<a title="编辑" href="<?php echo U('edit',array('id'=>$v['id']));?>" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> 

							<a title="删除" href="<?php echo U('del',array('id'=>$v['id']));?>" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
						</td>
...
<script type="text/javascript">
	...
	*/
	...
	function page(param){
		...
		start("<?php echo U('Admin/Admin/listajax');?>?p="+num+"&name="+where,
			function(data){
				var a = eval(data);
				$('#box').html(a);
			});
