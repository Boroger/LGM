...
<div class="page-container">
	<div class="text-c"> 
		...
		<button type="submit" class="btn btn-success radius" onclick="tests()"><i class="Hui-iconfont">&#xe665;</i> 搜用户</button>
	</div>
...
function page(param){
	...
	start("<?php echo U('Admin/Member/showdellistajax');?>?num="+num+"&title="+where,function(data){
		var a = eval(data);
		$('#contents').html(a);
	});
}
