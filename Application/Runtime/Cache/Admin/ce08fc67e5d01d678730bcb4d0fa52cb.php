...
<title>新增图片</title>
<link href="/web/Public/admin/lib/webuploader/0.1.5/webuploader.css" rel="stylesheet" type="text/css" />
</head>
<body>
...
<script type="text/javascript" src="/web/Public/admin/lib/icheck/jquery.icheck.min.js"></script> 
<script type="text/javascript" src="/web/Public/admin/lib/jquery.validation/1.14.0/jquery.validate.min.js"></script> 
<script type="text/javascript" src="/web/Public/admin/lib/jquery.validation/1.14.0/validate-methods.js"></script> 
<script type="text/javascript" src="/web/Public/admin/lib/jquery.validation/1.14.0/messages_zh.min.js"></script> 
...
<script type="text/javascript" src="/web/Public/admin/static/h-ui.admin/js/comment.js"></script>
<!--/_footer /作为公共模版分离出去-->

<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="/web/Public/admin/lib/webuploader/0.1.5/webuploader.min.js"></script> 
...
$(function(){
	...
	var uploader = WebUploader.create({
		auto: true,
		swf: '/web/Public/admin/lib/webuploader/0.1.5/Uploader.swf',
            ...
            if ( file.getStatus() === 'invalid' ) {
                ...
                uploader.makeThumb( file, function( error, src ) {
                    ...
                    if( isSupportBase64 ) {
                        ...
                        $.ajax('/web/Public/admin/lib/webuploader/0.1.5/server/preview.php', {
                            method: 'POST',
                            data: src,
                            dataType:'json'
