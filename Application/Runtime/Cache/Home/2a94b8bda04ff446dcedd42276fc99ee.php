...
<html lang="cn">
  	<head>
	    ...
	    <!-- Bootstrap -->
	    <link href="/Roger_www/web11152/Public/css/bootstrap.min.css" rel="stylesheet">
...
<nav class="navbar navbar-inverse" role="navigation">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><img style="margin-top: -7px" width="70px" src="/Roger_www/web11152/Public/home/image/logo.jpg"></a>
    </div>
...
<div id="myCarousel" class="carousel slide pic">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="/Roger_www/web11152/Public/home/image/lunbo1" alt="First slide">
    </div>
    <div class="item">
      <img src="/Roger_www/web11152/Public/home/image/lunbo2" alt="Second slide">
    </div>
    <div class="item">
      <img src="/Roger_www/web11152/Public/home/image/lunbo3" alt="Third slide">
    </div>
  </div>
  <!-- 轮播（Carousel）导航 -->
...
<div class="row">
        <!-- <div class="col-lg-10 col-sm-8">
            <div class="fl rec_img"><img style="border-radius: 5%" src="/Roger_www/web11152/Public/home/image/recommend1.jpg" alt="">
            </div>
            <div class="fl rec_img"><img style="border-radius: 5%" src="/Roger_www/web11152/Public/home/image/recommend1.jpg" alt="">
            </div>
            <div class="fl rec_img"><img style="border-radius: 5%" src="/Roger_www/web11152/Public/home/image/recommend1.jpg" alt="">
    ...
    <div class="col-md-10">
        <div class="row">
            <div class="col-sm-6 col-md-3">
                  <img  style="border-radius: 5%" src="/Roger_www/web11152/Public/home/image/recommend1.jpg" alt="...">
                  <div class="caption">
                  </div>
            </div>
            <div class="col-sm-6 col-md-3">
...
<div class="row" style="margin-top: 40px">
  ...
  <!-- </div>  gray -->
    ...
    <!-- jQuery -->
    <script src="/Roger_www/web11152/Public/js/jquery.min.js"></script>
    <!-- bootstrap.min.js 必须放在JQ之后!!! -->
    <script src="/Roger_www/web11152/Public/js/bootstrap.min.js"></script>
    <script src="/Roger_www/web11152/Public/js/holder.min.js"></script>
</body>
    <script>
    $(window).scroll(function()
    {
