...
<div>     
	...
	<div class="login_main">  
		<form action="<?php echo U('Login/dologin');?>" method="post" class="form form-horizontal" id="form-member-add">
		...
		<div class="row">
			<input type="password" style="height:44px;width:300px" class="input-text" value="" placeholder="&nbsp;密码:" id="password" name="password">
		</div>
		...
		<div class="row">
			<p style="color:white" class="fr">还没有账号,<a style="text-decoration: none;color:white;" href="<?php echo U('Home/Register/register');?>"><b>立即注册</b></a></p>
		</div>
		</form>
	</div>
		<div class="login_gif">
			<img style="width:480px; border-radius: 50%;" src="/LGM1116/Public/home/image/login.gif" alt="">
		</div>
</div>
	...
	<script type="text/ja        totalheight = parseFloat($(window).height()) + parseFloat($(window).scrollTop());     //浏览器的高度加上滚动条的高度 
vascript" src="/LGM1116/Public/admin/lib/My97DatePicker/WdatePicker.js"></script> 
